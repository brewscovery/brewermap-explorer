    ...
    if (status === 'approved' || status === 'rejected') {
      try {
        ...
        if (breweryError) {
          ...
          console.log('🔔 Calling create-notifications function for claim status update')
          
          // Call the create-notifications edge function to handle the notification
          ...
          if (notificationError) {
            console.error('❌ Error calling create-notifications function:', notificationError)
          } else {
            console.log(`✅ Successfully called create-notifications for claim status update`)
          }
        }
